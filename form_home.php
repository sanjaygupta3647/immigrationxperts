<form class="get-insurance__form" action="/testt/newmail/mail_crm_index/" method="POST" >
    <div class="get-insurance__content-box">
        <div class="row">
           ...
           <div class="col-xl-6 get-insurance__input-box">
				<select id="country-code" name="country-code" style="	height: 60px; width: 100%; border: 1px solid #dfe3e7; background-color: rgb(255, 255, 255);	box-shadow: 0px 5px 20px 0px rgba(0, 0, 0, 0.05); outline: none; font-size: 16px; color: var(--insur-gray);	font-weight: 400; padding: 0 30px 0; border-radius: var(--insur-bdr-radius);" required autocomplete="off">
