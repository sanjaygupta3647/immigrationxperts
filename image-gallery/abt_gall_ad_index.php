			...
			<div class="col-md-6">
				<div class="card mb-5">
					<div class="card-header">
						<h2 class="card-title">Add Gallery Item</h2>
					</div>
					<div class="card-body">
						<form action="abt_gall_ad_insert.php" method="POST" enctype="multipart/form-data">
							<div class="mb-3">
								<label for="category" class="form-label">Category:</label>
								<select id="category" name="category" class="form-select" required>
									<option value="" selected disabled>Select Category</option>
									<option value="immigration">Immigration Visa Grant</option>
									<option value="study">Study Overseas Visa Grant</option>
								</select>
							</div>
							<div class="mb-3">
