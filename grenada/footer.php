                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="footer-widget__column footer-widget__contact clearfix">
                        ...
                        <ul class="footer-widget__contact-list list-unstyled clearfix">
                            ...
                            <li><a href="/review/">Customer Testimonial</a></li>
            ...
            <div class="row">
                <div class="col-xl-5">
                    <div class="site-footer__bottom-inner">
                        <p class="site-footer__bottom-text">© 2024 Copyright Apical Immigration Experts All rights reserved
                        </p>
                    </div>
                </div>
                <div class="col-xl-7">
	...
	<div id="mobbb" style="z-index:1000000">
		<div class="container-fluid" style=" position: fixed;   bottom: 0px;z-index:1000000">
		  <div class="row text-center"style="padding:1%;background:#f2f2f2" >
			...
			<div class="col-4"  style=" border-right: 1px solid rgba(0, 0, 0, 0.2);">
				<a href="https://wa.me/919999467686"><img src="/assets/images/icon/whatsapp_n.png" alt="Call SVG" width="30px" height="30px" style="margin-bottom:15%">
					<p style="margin-top:-10px;font-size:14px;color:black">Whatsapp</p></a>
...
<!--end mobile footer strip -->
    ...
    <button type="submit" class="thm-btn get-insurance__btn" style=" margin-bottom: 57px;">Get free consultation</button>
</form>
