...
<link rel="stylesheet" type="text/css" href="<?php echo get_bloginfo('template_url');?>/css/style.css" id="" media="print, projection, screen" />
...
$(document).ready(function(){
	setTimeout(function(){ window.location.href='https://www.immigrationxperts.com/immigration-consultants-pune/'; }, 7000);
});
</script>
<div class="container">
