...
function wptools_install_plugin()
{
    ...
    if ($slug != "antihacker" && $slug != "toolstruthsocial" && $slug != "stopbadbots" && $slug != "wptools" && $slug != "recaptcha-for-all" && $slug != "wp-memory") {
       wp_die('wrong slug');
    }


	// if($slug != "wp-memory"  or $slug != "toolstruthsocial" or $slug != "antihacker" or $slug != "stopbadbots" or $slug != "wptools" or $slug != "recaptcha-for-all")
    if ($slug != "antihacker" && $slug != "toolstruthsocial" && $slug != "stopbadbots" && $slug != "wptools" && $slug != "recaptcha-for-all" && $slug != "wp-memory") 
    	wp_die('Fail error (-50)');
