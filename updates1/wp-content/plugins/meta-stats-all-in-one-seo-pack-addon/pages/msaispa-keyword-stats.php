...
<div class="wrap netgo-admin-page-setting">
	<h2><?php _e('All in One SEO Keyword Stats','');?></h2>
	<?php 
	$paged = (sanitize_text_field( $_GET['paged'] )) ? sanitize_text_field( $_GET['paged'] ) : 1;
	$post_per_page=10;
  ...
  <table class="wp-list-table widefat fixed striped pages">
   <tr>
	...
	<td colspan="2">
	<div align="right">
	 <form method="post" action="<?php echo get_option('home');?>/wp-admin/admin.php?page=msaispa-keyword-stats" id="posts-filter">  
  ...
  <table class="wp-list-table widefat fixed striped pages"> 
	...
	<thead>
	<tr>
	   <td width="50%"><strong><a class="class-to-<?php echo $classorder; ?>" href="<?php echo get_option('home');?>/wp-admin/admin.php?page=msaispa-keyword-stats&orderby=meta_value&order=<?php echo $ancorder; ?>"> Keyword</a></strong></td>
	...
	?>
	<tr>
	   <td width="50%"><?php echo $kword= get_post_meta( get_the_ID(), '_aioseop_keywords', true ); ?></td>
