...
<div class="wrap netgo-admin-page-setting">
  ...
  <table class="wp-list-table widefat fixed striped pages">
   <tr>
	...
	<td colspan="2">
	<div align="right">
	 <form method="post" action="<?php echo get_option('home');?>/wp-admin/admin.php?page=msaispa-description-stats" id="posts-filter">  
  ...
  <table class="wp-list-table widefat fixed striped pages"> 
	...
	<thead>
	<tr>
	   <td width="50%"><strong><a class="class-to-<?php echo $classorder; ?>" href="<?php echo get_option('home');?>/wp-admin/admin.php?page=msaispa-description-stats&orderby=meta_value&order=<?php echo $ancorder; ?>">Meta Description</a></strong></td>
