<div class="insurance-details__services-info mb-0">
    <h4 style="color: var(--insur-white);font-weight: 600; text-align: center;">Services</h4>
</div>
...
<div class="insurance-details__services-box">
    <ul class="insurance-details__services-list list-unstyled">
        <li><a href="/pte-pearson-test-of-english/">PTE (Pearson Test of English)<span class="icon-plane"></span></a></li>
        <li><a href="/ielts-international-english-language-testing-system/">IELTS (International English Language Testing System)<span class="icon-plane"></span></a></li>
        <li><a href="/pre-landing/">Pre Landing<span class="icon-plane"></span></a></li>
        <li><a href="/post-landing/">Post Landing<span class="icon-plane"></span></a></li>
        <li><a href="/forex-card/">Forex Card<span class="icon-plane"></span></a></li>
    </ul>
</div>
...
<div id="carouselExample" class="carousel slide mt-3" data-ride="carousel" data-interval="2000"> <!-- Reduced interval to 2 seconds -->
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <a href="https://www.immigrationxperts.com/blog/how-to-get-scholarship-to-study-in-usa/" target="_blank">
        <img src="/assets/images/services/ser1.png" class="d-block w-100" alt="Image 1">
      </a>
    </div>
    ...
    <div class="carousel-item">
      <a href="https://www.immigrationxperts.com/blog/how-can-you-extend-your-stay-in-canada-after-graduation/" target="_blank">
        <img src="/assets/images/services/ser2.png" class="d-block w-100" alt="Image 2">
      </a>
    </div>
    ...
    <!-- Slide 1 -->
    <div class="carousel-item">
      <a href="https://www.immigrationxperts.com/blog/how-important-are-academic-grades-for-full-scholarships-in-uk/" target="_blank">
        <img src="/assets/images/services/ser3.png" class="d-block w-100" alt="Image 3">
      </a>
    </div>
    ...
    <!-- Slide 1 -->
    <div class="carousel-item">
      <a href="https://www.immigrationxperts.com/blog/what-rights-do-you-have-as-a-spouse-visa-holder-in-australia/" target="_blank">
        <img src="/assets/images/services/spouse_visa.webp" class="d-block w-100" alt="Image 4">
      </a>
    </div>
    ...
    <!-- Slide 1 -->
    <div class="carousel-item">
      <a href="https://www.immigrationxperts.com/blog/how-can-international-students-find-scholarships-for-studying-in-the-usa/" target="_blank">
        <img src="/assets/images/services/ser5.png" class="d-block w-100" alt="Image 5">
      </a>
    </div>
    ...
    <!-- Slide 1 -->
    <div class="carousel-item">
      <a href="https://www.immigrationxperts.com/blog/how-can-you-secure-a-scholarship-to-study-in-the-usa/" target="_blank">
        <img src="/assets/images/services/ser6.png" class="d-block w-100" alt="Image 6">
      </a>
    </div>
