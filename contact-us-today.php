        ...
        <section class="page-header" style="background: linear-gradient(to right, #01406b, #00bdce); color: #fff; padding: 70px 0 70px;">  
            <div class="container">
                <div class="page-header__inner">
                    ...
                    <h2 style="color: #b8e1f0;">Contact Us</h2>
                </div>
            </div>
        </section>
        <!--Page Header End-->
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="contact-page__left">
                            <div class="section-title text-left">
                                ...
                                <h1 class="section-title__title">Feel free to get in touch with experts</h1>
                                <p class="contact-page__location-text">Foundation was established with a small idea that
                                    was incepted in the minds of
                                    its promoters in the year 2008! We are skillfully.</p>
