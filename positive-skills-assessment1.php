    ...
    <?php include 'header.php';?>
     ...
     <div class="page-wrapper">
        ...
        <section class="page-header mb-3">
            <div class="page-header-bg" style="background-image: url(/assets/images/backgrounds/sucess.webp)">
            </div>
		...
		<div class="container">
            <div class="page-header__inner">
                <ul class="thm-breadcrumb list-unstyled">
                    <li><a href="/">Home</a></li>
                    <li><span>/</span></li>
                    <li>Positive Skills Assessment</li>
                </ul>
            </div>
        </div>
               ...
               <div class="col-xl-12">
                    ...
                    function getCategoryImage($category) {
                        switch ($category) {
                            ...
                            case 'VISA GRANTS CANADA / AUSTRALIA':
                                return '/assets/images/icon/canada1.webp';
                            default:
                                return '';
                        }
                    }
