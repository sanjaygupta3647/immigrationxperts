...
try {
    if(!empty($_POST)){
        ...
        $bodyMessage .= "<tr><td>Phone: </td><td>".$postData['phone1']."</td></tr>";
        $bodyMessage .= "<tr><td>Age : </td><td>".$postData['age']."</td></tr>";
        $bodyMessage .= "<tr><td>Eduction: </td><td>".$postData['qualification']."</td></tr>";
        ...
        $bodyMessage .= "<tr><td>Visa Type: </td><td>".$postData['branch']."</td></tr>";
        ...
        $mail->SMTPSecure = "ssl";
        $mail->Port = 465;
        $mail->Host = "immigrationxperts.com";
        ...
        $mail->addAddress("info@immigrationxperts.com", "me");
