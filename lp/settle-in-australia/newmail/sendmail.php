...
//	print_r($postData);die;
 ...
 //  $mail->SMTPDebug = 2;                    //Enable verbose debug output
   ...
   // $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    ...
    //Recipients
    $mail->setFrom('noida@immigrationxperts.com', 'Australia Immigration Landing page');
    $mail->addAddress('noida@immigrationxperts.com', 'Australia Immigration Landing page');     //Add a recipient
   ...
   // $mail->addAttachment('/var/tmp/file.tar.gz');         //Add attachments
    ...
    $mail->Subject = "Australia Immigration Landing Page Lead - Google Ads PI";
  ...
  if(!$mail->send()){
   ...
   echo '<script>window.location.href = "/lp/settle-in-australia/thankyou.php";</script>';
