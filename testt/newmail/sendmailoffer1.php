...
if (!empty($_POST)) {
    ...
    $bodyMessage .= "<tr><td>offer: </td><td>".$postData['offer']."</td></tr>";
    ...
    // Set up recipients
    $mail->setFrom('noida@immigrationxperts.com', 'Christmas Offer'); // Set the sender
    $mail->addAddress('noida@immigrationxperts.com', 'Christmas Offer'); // Add a recipient
    ...
    $mail->Subject = "Christmas Offer: " . $canonical_url; // Set the subject of the email
