...
<head>
    ...
    <title>Point Test Calculator | Widget</title>
    <!-- Vendor -->
    <link rel="stylesheet" href="https://app.searchmyanzsco.com.au/pointtestcalculator/vendor/bootstrap/css/bootstrap.min.css">
...
<body>
    ...
    <header
        class="bg-white border-bottom navbar-light navbar-expand-lg end-0 position-fixed py-2 shadow-sm start-0 z-index-1">
        <div class="container-fluid">
            <div class="row gy-1 align-items-center justify-content-between justify-content-lg-start">    
            </div>
        </div>
    </header>
    <!-- /Header -->
    ...
    <!-- /download modal-->
    <!-- Main -->
    <main class="d-inline-block mt-4 pt-5 w-100">
        <section class="py-4">
            <div class="container-fluid">
					  ...
					  <h2>Score for this criteria: <span>0 Points</span></h2>
						...
						<?php
							...
							if (!empty($pdfFileName)) {
								echo "<button onclick=\"window.open('$pdfFileName', '_blank'); window.location.href = 'new.php';\">Download PDF</button>";
							} else {
