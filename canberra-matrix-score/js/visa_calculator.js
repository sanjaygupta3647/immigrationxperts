...
$("#calculator_form").submit(function(event) {
	...
	if($('input[name="eng_ablity"]:checked').length === 0) {
		...
		if($('input[name="eng_ablity_1"]:checked').length === 0) {
		$(".english_language_sec_1").addClass('bg-error');
		$('html, body').animate({ scrollTop: $(".english_language_sec_1").offset().top }, 1000);
		return false;
	}
	
		if($('input[name="regional_study_1"]:checked').length === 0) {
		$(".regional_study_section_1").addClass('bg-error');
		$('html, body').animate({ scrollTop: $(".regional_study_section_1").offset().top }, 1000);
		return false;
	}
		if($('input[name="specialist_edu"]:checked').length === 0) {
		$(".specialist_qualification_section").addClass('bg-error');
		$('html, body').animate({ scrollTop: $(".specialist_qualification_section").offset().top }, 1000);
		return false;
	}
...
$('input[name="regional_study_1"]').click(function(){
	if($(this).prop("checked") == true){
		$(".regional_study_section_1").removeClass('bg-error');
	}
});
$('input[name="specialist_edu"]').click(function(){
	if($(this).prop("checked") == true){
		$(".specialist_qualification_section").removeClass('bg-error');
	}
});
